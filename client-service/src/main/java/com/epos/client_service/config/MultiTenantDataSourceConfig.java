package com.epos.client_service.config;

import com.epos.client_service.tenant.RoutingDataSource;
import com.epos.client_service.tenant.TenantDataSourceProvider;
...
public class MultiTenantDataSourceConfig {
    ...
    public DataSource dataSource(TenantDataSourceProvider provider) {
        ...
        // obavezno: targetDataSources NE smije biti prazno
